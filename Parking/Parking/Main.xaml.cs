...
//using Position = Xamarin.Forms.BetterMaps.Position;
...
namespace Parking
{
    ...
    public partial class Main : FlyoutPage
    {
        ...
        public Main(string v1, string v2, string v3, string v4, string v5)
        {
            try
            {
                InitializeComponent();
        ...
        public Main(string v1, string v2, string v3, string v4, string v5, string text, string flag)
        {
            try
            {
                InitializeComponent();
        ...
        {
            Navigation.PushAsync(new MyParkings(SId, SName, SEmail, SPhone, SPass));
        }
        ...
        {
            Navigation.PushAsync(new AddParking(SId, SName, SEmail, SPhone, SPass));
        }

        private void TapGestureRecognizer_Tapped_1(object sender, EventArgs e)
        {
            Navigation.PushAsync(new ParkingInfo(SId, SName, SEmail, SPhone, SPass));
        }
        ...
        //private void meramap_MapClicked(object sender, MapClickedEventArgs e)
        //{
